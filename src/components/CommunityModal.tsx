...
export function CommunityModal({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="mb-8 text-center mt-6 md:mt-0">
          ...
          <h2 className="mb-2 text-2xl font-bold md:text-3xl font-display text-white">
            JOIN M FOREX CAPITAL COMMUNITY 🚀
          </h2>
          <p className="text-slate-400">
            Apne favourite platform te M Forex Capital naal juddo.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {/* WhatsApp */}
          <a
            href="https://chat.whatsapp.com/CHWthrGsb7m01tgUxMH7Ft?s=cl&p=i&mlu=0&ilr=0&amv=0"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative overflow-hidden rounded-xl bg-brand-card p-6 text-center transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-green-500/20"
          >
            ...
            <h3 className="mb-2 font-bold text-white">Join WhatsApp Community</h3>
            <span className="inline-block rounded-full bg-green-500/20 px-4 py-1.5 text-sm font-semibold text-green-400">
              JOIN WHATSAPP
            </span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative overflow-hidden rounded-xl bg-brand-card p-6 text-center transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/20"
          >
            ...
            <h3 className="mb-2 font-bold text-white">Join Telegram Community</h3>
            <span className="inline-block rounded-full bg-blue-500/20 px-4 py-1.5 text-sm font-semibold text-blue-400">
              JOIN TELEGRAM
            </span>
          </a>
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/m.forex.capital"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative overflow-hidden rounded-xl bg-brand-card p-6 text-center transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-500/20"
          >
            ...
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-pink-500/20 text-pink-500">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="mb-2 font-bold text-white">Follow @m.forex.capital</h3>
            <span className="inline-block rounded-full bg-pink-500/20 px-4 py-1.5 text-sm font-semibold text-pink-400">
              FOLLOW INSTAGRAM
            </span>
          </a>
        </div>
